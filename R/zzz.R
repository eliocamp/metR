...
.onLoad <- function(libname, pkgname) {
  ...
  ggplot2::register_theme_elements(
    palette.label_colour.continuous = scales::pal_seq_gradient(
      "#132B43",
      "#56B1F7"
    ),
    element_tree = list(
      palette.label_colour.continuous = ggplot2::el_def(c(
        "character",
        "numeric",
        "integer",
        "function"
  ...
  ggplot2::register_theme_elements(
    palette.stroke.colour.continuous = scales::pal_seq_gradient(
      "#132B43",
      "#56B1F7"
    ),
    element_tree = list(
      palette.stroke.colour.continuous = ggplot2::el_def(c(
        "character",
        "numeric",
        "integer",
        "function"
