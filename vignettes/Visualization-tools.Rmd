...
Another posible use it to quickly mask missing values.
...
(g <- ggplot(temperature[lev == 300], aes(lon, lat, z = air.z)) +
     ...
     scale_fill_divergent() +
     scale_x_longitude(labels = waiver(), trans = "lon180") +
...
ggplot(temperature[lev == 300], aes(lon, lat, z = air.z)) +
    ...
    scale_fill_divergent() +
    scale_x_longitude(labels = waiver()) +
    scale_y_latitude(limits = c(-90, -20)) +
    coord_polar()
```
